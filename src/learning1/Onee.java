    ...
    public static void arrayRandom() {
        try (Scanner keyboard = new Scanner(System.in)) {
            ...
            for (int i = 0; i < numbers; i++) {
                array[i] = generateRandomInt(0, 10);
            }
            ...
            if (hasElement(element, array)) {
                System.out.println("Number " + element + " is in the array");
            } else {
                System.out.println("Number " + element + " is not in the array");
            }
        }
    }

    private static boolean hasElement(int element, int[] array) {
